...
|---|---|---|---|
| 2026-08-29 | `2026-08-29-mac-layout-switcher` | сдан | Аналог Punto/Caramba: авто-исправление, хоткеи, автозамена, звуки, автозапуск, RU/EN-индикатор в трее, утка-иконка, .app+.dmg |
