...
|---|---|---|---|
| 2026-08-29 | `2026-08-29-mac-layout-switcher` | сдан | Аналог Punto/Caramba со всем фаршем: авто-исправление, хоткеи, автозамена, автозапуск, RU/EN в трее, утка, .dmg, автообновление через GitHub |
