...
|---|---|---|---|
| 2026-08-29 | `2026-08-29-mac-layout-switcher` | сдан | Аналог Punto/Caramba: авто-исправление, хоткеи, автозамена, звук исправлений, автозапуск, RU/EN в трее, утка-иконка, .app+.dmg |
