...
|---|---|---|---|
| 2026-08-29 | `2026-08-29-mac-layout-switcher` | сдан | Аналог Punto/Caramba: авто-исправление раскладки + настраиваемые хоткеи, откат с порогом, автозамена, звуки, сборка .app и .dmg |
