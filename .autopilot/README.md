...
|---|---|---|---|
| 2026-08-29 | `2026-08-29-mac-layout-switcher` | сдан | Аналог Punto/Caramba: авто-исправление ДО Enter, короткие слова, хоткеи, автозамена, автозапуск, RU/EN в трее, утка, .dmg, автообновление (v1.2.0) |
